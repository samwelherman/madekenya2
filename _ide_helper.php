...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function makepayment($firstname, $amount, $lastname, $email, $type, $reference, $description, $phone_number)
        {
                        /** @var \Epmnzava\Pesapal\Pesapal $instance */
                        return $instance->makepayment($firstname, $amount, $lastname, $email, $type, $reference, $description, $phone_number);
        }
                    /**
         * 
         *
         * @static 
         */ 
        public static function construct_xml_request()
        {
                        /** @var \Epmnzava\Pesapal\Pesapal $instance */
                        return $instance->construct_xml_request();
        }
     ...
     */ 
        ...
        {
                        /** @var \Epmnzava\PaypalLaravel\PaypalLaravel $instance */
         ...
         * @param $handling_fee
         * @param $description
         * @return array /v1/payments/payment/
         ...
         * @static 
         */ 
        public static function CreatePayment($amount, $tax, $shipping, $handling_fee, $description)
        {
                        /** @var \Epmnzava\PaypalLaravel\PaypalLaravel $instance */
                        return $instance->CreatePayment($amount, $tax, $shipping, $handling_fee, $description);
        }
                    /**
         * 
         *
         * @param $PayeID
         * @param $payer_id
         * @return bool|string /v1/payments/payment/PAY-XXX/execute
         * @static 
         */ 
        public static function executePayment($PayeID, $payer_id)
        {
                        /** @var \Epmnzava\PaypalLaravel\PaypalLaravel $instance */
                        return $instance->executePayment($PayeID, $payer_id);
        }
                    /**
         * POST
        ...
        {
                        /** @var \Epmnzava\PaypalLaravel\PaypalLaravel $instance */
                        return $instance->generateInvoiceNumber();
        }
                    /**
         * GET
         ...
         * @param $amount
         * @param array $items
         * @return array Function to create an order  /v2/checkout/orders
         * @static 
         */ 
        public static function createOrder($reference_id, $amount, $items = [])
        {
                        /** @var \Epmnzava\PaypalLaravel\PaypalLaravel $instance */
                        return $instance->createOrder($reference_id, $amount, $items);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function auditColumn($nullable = false, $polymorphicColumnTypeString = false)
        {
                        \Illuminate\Database\Schema\Blueprint::auditColumn($nullable, $polymorphicColumnTypeString);
        }
                    /**
         * Add the proper audit columns for a polymorphic table.
         *
         ...
         * @static 
         */ 
        public static function bigAuditColumn($nullable = false)
        {
                        \Illuminate\Database\Schema\Blueprint::bigAuditColumn($nullable);
        }
                    /**
         ...
         * @static 
         */ 
        public static function bigMorphs($name, $indexName = null)
        {
                        \Illuminate\Database\Schema\Blueprint::bigMorphs($name, $indexName);
        }
                    /**
         * Add nullable audit columns for a polymorphic table.
         *
         ...
         * @static 
         */ 
        public static function bigMorphsNullable($name, $indexName = null)
        {
                        \Illuminate\Database\Schema\Blueprint::bigMorphsNullable($name, $indexName);
        }
                    /**
         * Add tree column for Nested Set.
         *
         * @return void 
         * @param mixed $localColumnName
         * @param mixed $foreignTable
         * @param mixed $foreignPrimaryColumn
         * @param mixed $nullable
         * @param mixed $index
         * @param mixed $cascades
         * @static 
         */ 
        public static function foreignBigInteger($localColumnName, $foreignTable, $foreignPrimaryColumn = 'id', $nullable = false, $index = true, $cascades = null)
        {
                        \Illuminate\Database\Schema\Blueprint::foreignBigInteger($localColumnName, $foreignTable, $foreignPrimaryColumn, $nullable, $index, $cascades);
        }
                    /**
         * Add tree column for Nested Set.
         *
         ...
         * @static 
         */ 
        public static function foreignBigIntegerNullable($localColumnName, $foreignTable, $foreignPrimaryColumn = 'id', $nullable = true, $index = true, $cascades = null)
        {
                        \Illuminate\Database\Schema\Blueprint::foreignBigIntegerNullable($localColumnName, $foreignTable, $foreignPrimaryColumn, $nullable, $index, $cascades);
        }
                    /**
         * Add tree column for Nested Set.
         *
         ...
         * @static 
         */ 
        public static function foreignColumn($dataType, $localColumnName, $foreignTable, $foreignPrimaryColumn = 'id', $nullable = false, $index = true, $cascades = null)
        {
                        \Illuminate\Database\Schema\Blueprint::foreignColumn($dataType, $localColumnName, $foreignTable, $foreignPrimaryColumn, $nullable, $index, $cascades);
        }
                    /**
         * Add tree column for Nested Set.
         *
         ...
         * @static 
         */ 
        public static function foreignInteger($localColumnName, $foreignTable, $foreignPrimaryColumn = 'id', $nullable = false, $index = true, $cascades = null)
        {
                        \Illuminate\Database\Schema\Blueprint::foreignInteger($localColumnName, $foreignTable, $foreignPrimaryColumn, $nullable, $index, $cascades);
        }
                    /**
         * Add tree column for Nested Set.
         *
         ...
         * @static 
         */ 
        public static function foreignIntegerNullable($localColumnName, $foreignTable, $foreignPrimaryColumn = 'id', $nullable = true, $index = true, $cascades = null)
        {
                        \Illuminate\Database\Schema\Blueprint::foreignIntegerNullable($localColumnName, $foreignTable, $foreignPrimaryColumn, $nullable, $index, $cascades);
        }
                    /**
         * Add tree column for Nested Set.
         *
         ...
         * @static 
         */ 
        public static function nestedSetColumns()
        {
                        \Illuminate\Database\Schema\Blueprint::nestedSetColumns();
        }
                    /**
         * Add nullable audit columns for a polymorphic table.
         *
         ...
         * @static 
         */ 
        public static function nullableAuditColumn($polymorphicColumnTypeString = false)
        {
                        \Illuminate\Database\Schema\Blueprint::nullableAuditColumn($polymorphicColumnTypeString);
        }
                    /**
         * Add nullable audit columns for a polymorphic table.
         *
         ...
         * @static 
         */ 
        public static function nullableBigAuditColumn()
        {
                        \Illuminate\Database\Schema\Blueprint::nullableBigAuditColumn();
        }
                    /**
         * Add nullable audit columns for a polymorphic table.
         *
         ...
         * @static 
         */ 
        public static function stringMorphs($name, $indexName = null)
        {
                        \Illuminate\Database\Schema\Blueprint::stringMorphs($name, $indexName);
        }
                    /**
         * Add nullable audit columns for a polymorphic table.
         *
         ...
         * @static 
         */ 
        public static function stringMorphsNullable($name, $indexName = null)
        {
                        \Illuminate\Database\Schema\Blueprint::stringMorphsNullable($name, $indexName);
        }
...
namespace  { 
            ...
            class Pesapal extends \Epmnzava\Pesapal\PesapalFacade {}
            ...
            class PaypalLaravel extends \Epmnzava\PaypalLaravel\PaypalLaravelFacade {}
