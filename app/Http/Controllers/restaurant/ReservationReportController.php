    ...
    public function index(Request $request)
    {
        ...
        if ($_POST) {
            ...
            if (!blank($dateBetween)) {
                $this->data['reservations'] = Reservation::where($queryArray)->whereBetween('created_at', [$dateBetween['from_date'], $dateBetween['to_date']])->descending()->get();
            } else {
                $this->data['reservations'] = Reservation::where($queryArray)->descending()->get();
            }

        }
        return view('restaurant.report.tableBooking.index', $this->data);
    }
