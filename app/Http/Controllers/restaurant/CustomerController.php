...
class CustomerController extends BackendController
{
    ...
    {
        return view('restaurant.customer.index', $this->data);
    }
    ...
    public function show($id)
    {
        ...
        return view('restaurant.customer.show', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        $this->data['user'] = User::role($role->name)->findOrFail($id);
        return view('restaurant.customer.edit', $this->data);
    }
    ...
    public function update(CustomerRequest $request, $id)
    {
        ...
        return redirect(route('customers.index'))->withSuccess('The Data Updated Successfully');
    }
