...
Breadcrumbs::for ('dashboard', function ($trail) {
    $trail->push(trans('validation.attributes.dashboard'), route('dashboard.index'));
});
...
Breadcrumbs::for ('departments', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.departments'), route('departments.index'));
});
...
Breadcrumbs::for ('designations', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.designations'), route('designations.index'));
});
...
Breadcrumbs::for ('employees', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.employees'), route('employees.index'));
});
...
Breadcrumbs::for ('pre-registers', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.pre-registers'), route('pre-registers.index'));
});
...
Breadcrumbs::for ('visitors', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.visitors'), route('visitors.index'));
});
...
Breadcrumbs::for ('administrators', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.administrators'), route('adminusers.index'));
});
...
Breadcrumbs::for ('roles', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.roles'), route('role.index'));
});
...
Breadcrumbs::for ('language', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.language'),route('language.index'));
});
...
Breadcrumbs::for ('addons', function ( $trail) {
    $trail->parent('dashboard');
    $trail->push(trans('validation.attributes.addons'), route('addons.index'));
});
