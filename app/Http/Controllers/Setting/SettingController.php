...
class SettingController extends Controller
{
    ...
    public function siteSettingUpdate(Request $request)
    {
        ...
        $settingArray = $request->except('_token');
        ...
        Setting::where('id',1)->update($settingArray);

        return redirect(route('setting.index'))->withSuccess('The Site setting updated successfully');
    }
    ...
    public function smsSettingUpdate(Request $request)
    {
        ...
        Setting::where('id',1)->update($settingArray);
        return redirect(route('setting.sms'))->withSuccess('The SMS setting updated successfully.');
    }
    ...
    public function mailTemplateSettingUpdate(Request $request)
    {
        ...
        Setting::where('id',1)->update($settingArray);
        return redirect(route('setting.email-template'))->withSuccess('The Email & Sms template setting updated successfully.');
    }
    ...
    public function emailSettingUpdate(Request $request)
    {
        ...
        // Setting::save();
        Setting::where('id',1)->update($emailSettingArray);

        return redirect(route('setting.email'))->withSuccess('The Email setting updated successfully');
    }
    ...
    public function notificationSettingUpdate(Request $request)
    {
        ...
        $notificationSettingArray = $request->all();
        ...
        return redirect(route('setting.notification'))->withSuccess('The Notification setting updated successfully.');
    }
    ...
    public function homepageSettingUpdate(Request $request)
    {
        ...
        return redirect(route('setting.homepage'))->withSuccess('The Home page setting updated successfully');
    }
