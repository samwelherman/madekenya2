...
function variationItemDesign() {
    ...
    markup += '<tr>';
        ...
        markup +='</td>';
        markup +='<td>';
            markup += '<input type="number" name="variation['+menu_item_variation_count+'][price]" placeholder="Price" class="form-control form-control-sm change-productprice">';
        markup += '</td>';
        markup +='<td>';
        markup +='<input type="number" name="variation['+menu_item_variation_count+'][discount_price]" placeholder="Discount Price" class="form-control form-control-sm change-productdiscountprice">';
        markup +='</td>';
        markup +='<td>';
...
function optionItemDesign() {
    ...
    markup += '<tr>';
        ...
        markup +='</td>';
        markup +='<td>';
            markup += '<input type="number" name="option['+menu_item_option_count+'][price]" placeholder="Price" class="form-control form-control-sm change-productprice">';
        markup += '</td>';
        markup +='<td>';
            markup += '<button class="btn btn-danger btn-sm removeBtn">'
                markup += '<i class="fa fa-trash"></i>';
