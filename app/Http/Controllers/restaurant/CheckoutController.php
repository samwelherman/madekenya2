...
use App\Notifications\Restaurant\OrderCreated;
use App\Http\Services\StripeService;
use App\Http\Services\restaurant\PaymentService;
...
class CheckoutController extends FrontendController
{
    ...
    public function index()
    {
        ...
        return view('restaurant.frontend.restaurant.checkout', $this->data);
    }
